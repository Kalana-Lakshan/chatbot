...
const sendMessage = async (message) => {
  ...
  async function makePostRequest(msg) {
    const url = 'http://localhost:5000/chatbot'; //'https://sinanz-5000.theianext-0-labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai/chatbot';  // Make a POST request to this url
    const requestBody = {
      prompt: msg
    };
